    ...
    <div className="frame-261">
      <div className="frame-246">
        ...
        <div className="frame-140-10">
          <a href="https://www.twitter.com/africariyoki/"  target="_blank"><img className="twitter-negative" src={twitterLogo} /></a>
          <a href="https://www.instagram.com/africariyoki/"  target="_blank"><img className="instagram-negative" src={instagramLogo} /></a>
        </div>
      </div>
