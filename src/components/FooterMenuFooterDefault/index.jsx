    ...
    <div className={`footer-default ${className || ""}`}>
      <div className="frame-142">
        ...
        <div className="frame-140">
          <a href="https://www.twitter.com/africariyoki/"  target="_blank"><img className="twitter-negative" src={twitterIcon} /></a>
          <a href="https://www.instagram.com/africariyoki/"  target="_blank"><img className="instagram-negative" src={instagramIcon} /></a>
        </div>
      </div>
    </div>
  );
