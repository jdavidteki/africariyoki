...
class Recorder extends Component {
    ...
    // visualSelect = document.querySelector('#visSelect');
        ...
        return (
            <div className="Recorder">
              <div className="Recorder-upperLevel">
                <button class="Record-controls" ref={ref => this.startRecord = ref} id="record"><MicIcon style={{color: this.micIcon}}/></button>
                <button class="Record-controls" ref={ref => this.stopRecord = ref} id="stop"><StopIcon MicIcon style={{color: "#3413f1"}} /></button>
                <canvas ref={ref => this.canvas = ref} height="50" width="280" ></canvas>
                <a class="Record-controls" id="download" ref={ref => this.download = ref}><GetAppIcon MicIcon style={{color: "#3413f1"}} /></a>
              </div>
